/* linux/arch/arm/mach-exynos/board-chagall-gpio.c
 *
...
/*
======================================================
chagall revision history from system_rev
======================================================
*/
...
static struct sleep_gpio_tables chagall_sleep_gpio_tables[MAX_BOARD_REV];
static int nr_chagall_sleep_gpio_table;

/* init gpio table for CHAGALL project */
static struct gpio_init_data __initdata init_gpio_table[] = {
    ...
    /* GPA 2 */
#if !defined(CONFIG_CHAGALL_WIFI)
...
static struct gpio_sleep_data sleep_gpio_table_latest[] = {
...
#endif
	{ EXYNOS5420_GPA2(2), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
	{ EXYNOS5420_GPA2(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
...
#if defined(CONFIG_CHAGALL_WIFI) || defined(CONFIG_CHAGALL_TD)
    ...
    /* GPE 1 */
	{ EXYNOS5420_GPE1(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
...
#if defined(CONFIG_CHAGALL_3G) || defined(CONFIG_CHAGALL_LTE)
	{ EXYNOS5420_GPG0(4), S5P_GPIO_PD_OUTPUT1, S5P_GPIO_PD_UPDOWN_DISABLE }, /* CP_PMU_RST */
#elif defined(CONFIG_CHAGALL_TD)
    ...
    /* GPG 1 */
#if defined(CONFIG_CHAGALL_3G) || defined(CONFIG_CHAGALL_LTE) || defined(CONFIG_CHAGALL_TD)
...
#endif
	{ EXYNOS5420_GPG1(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
    ...
    /* GPX 3 */
	{ EXYNOS5420_GPX3(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* TCON_INTR */
	{ EXYNOS5420_GPX3(6), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* TCON_RDY */
    /* GPY 0 */
...
static void config_sleep_gpio_tables(void)
{
	...
	for (i = nr_chagall_sleep_gpio_table - 1; i >= 0; i--)
		config_sleep_gpio(chagall_sleep_gpio_tables[i].table,
				chagall_sleep_gpio_tables[i].arr_size);
}

void __init board_chagall_gpio_init(void)
{
	int i = 0;
	...
	switch (system_rev) {
	case 0:
		chagall_sleep_gpio_tables[i].table = sleep_gpio_table_rev00;
		chagall_sleep_gpio_tables[i].arr_size =
			ARRAY_SIZE(sleep_gpio_table_rev00);
		i++;
		/* Fall through */
	default:
		chagall_sleep_gpio_tables[i].table = sleep_gpio_table_latest;
		chagall_sleep_gpio_tables[i].arr_size =
			ARRAY_SIZE(sleep_gpio_table_latest);
		i++;
		break;
	}
	nr_chagall_sleep_gpio_table = i;
