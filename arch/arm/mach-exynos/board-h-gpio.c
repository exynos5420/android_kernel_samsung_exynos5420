...
static struct gpio_init_data __initdata init_gpio_table[] = {
	...
	{ EXYNOS5420_GPX2(3), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* W_CHG_DET */
	{ EXYNOS5420_GPX2(4), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* T_FLASH_DETECT */
	{ EXYNOS5420_GPX2(6), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* CP_DUMP_INT */
	{ EXYNOS5420_GPX2(7), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* HSPA_ACTIVE */
