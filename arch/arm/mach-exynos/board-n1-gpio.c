...
static struct gpio_init_data __initdata init_gpio_table[] = {
...
#if defined(CONFIG_N1A_WIFI) || defined(CONFIG_N2A_WIFI)
	...
	{ EXYNOS5420_GPX2(3), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* COND_DET_AP */
	{ EXYNOS5420_GPX2(4), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* T_FLASH_DETECT */
       
#if defined(CONFIG_N1A_3G)
	{ EXYNOS5420_GPX2(6), S3C_GPIO_INPUT, GPIO_LV_L, S3C_GPIO_PULL_NONE}, /* NC(CP_DUMP_INT) */
	{ EXYNOS5420_GPX2(7), S3C_GPIO_INPUT, GPIO_LV_L, S3C_GPIO_PULL_NONE }, /* NC(HSPA_ACTIVE) */
#endif
    /* GPX 3 */
...
static struct gpio_sleep_data sleep_gpio_table_default[] = {
...
#if defined(CONFIG_N1A_3G)
	{ EXYNOS5420_GPX2(6), S5P_GPIO_PD_INPUT,  S5P_GPIO_PD_UPDOWN_DISABLE }, /* NC(CP_DUMP_INT) */
	{ EXYNOS5420_GPX2(7), S5P_GPIO_PD_INPUT,  S5P_GPIO_PD_UPDOWN_DISABLE }, /* NC(HSPA_ACTIVE) */
#endif
     /* GPY 0 */
	...
	/* GPX 0 */
	{ EXYNOS5420_GPX2(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE }, /* COND_DET_AP */
#if 0
	/*
