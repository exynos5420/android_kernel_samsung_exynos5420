...
REGULATOR_INIT(ldo33, "vcc_2.8v_ap", 2800000, 2800000, 1,
		REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo35, "cam_sensor_core_1.2v", 1050000, 1200000, 0,
		REGULATOR_CHANGE_VOLTAGE, 0);
...
void __init board_n1_pmic_init(void)
{
