...
/*
======================================================
v1 revision history from system_rev
======================================================
1. system_rev 5, 6 : WIFI
2. system_rev 7, 8, 9 : 3G
*/
...
static struct gpio_init_data __initdata init_gpio_table[] = {
	...
	{ EXYNOS5420_GPD1(5), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* MOTOR_I2C_SDA */
	{ EXYNOS5420_GPD1(6), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* MOTOR_I2C_SCL */
#endif
...
static struct gpio_sleep_data sleep_gpio_table_latest[] = {
...
#endif
#if defined(CONFIG_V2A)
	{ EXYNOS5420_GPD1(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
...
#endif
#if defined(CONFIG_V1A_3G) || defined(CONFIG_V2A_3G)
	{ EXYNOS5420_GPD1(7), S5P_GPIO_PD_OUTPUT0, S5P_GPIO_PD_UPDOWN_DISABLE }, /* PDA_ACTIVE */
#else
	{ EXYNOS5420_GPD1(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* NC */
#endif
    ...
    /* GPX 0 */
    { EXYNOS5420_GPX0(5), S3C_GPIO_INPUT, S3C_GPIO_PULL_DOWN },  /* KBC3_HOME_BTN_N */
    /* GPY 0 */
	...
	{ EXYNOS5420_GPY7(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* TP4010 */
...
static void config_sleep_gpio_tables(void)
{
	...
	for (i = nr_v1_sleep_gpio_table - 1; i >= 0; i--)
		config_sleep_gpio(v1_sleep_gpio_tables[i].table,
				v1_sleep_gpio_tables[i].arr_size);
}
...
void __init board_v1_gpio_init(void)
{
	...
	switch (system_rev) {
	case 0:
		v1_sleep_gpio_tables[i].table = sleep_gpio_table_rev00;
		v1_sleep_gpio_tables[i].arr_size =
			ARRAY_SIZE(sleep_gpio_table_rev00);
		i++;
		/* Fall through */
	default:
		v1_sleep_gpio_tables[i].table = sleep_gpio_table_latest;
		v1_sleep_gpio_tables[i].arr_size =
			ARRAY_SIZE(sleep_gpio_table_latest);
		i++;
		break;
	}
	nr_v1_sleep_gpio_table = i;
