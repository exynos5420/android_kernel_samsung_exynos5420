...
#define	GPIO_SENSOR_SDA			EXYNOS5420_GPA1(2)
#define	GPIO_SENSOR_SCL			EXYNOS5420_GPA1(3)

#define	GPIO_VISION_SDA_18V		EXYNOS5420_GPA1(4)
#define	GPIO_VISION_SCL_18V		EXYNOS5420_GPA1(5)

#define	GPIO_GRIP_SDA			EXYNOS5420_GPA2(0)
#define	GPIO_GRIP_SCL			EXYNOS5420_GPA2(1)
#define	GPIO_PMIC_DVS1			EXYNOS5420_GPA2(2)
#define	GPIO_PMIC_DVS2			EXYNOS5420_GPA2(3)
#define	GPIO_LCDP_SDA			EXYNOS5420_GPA2(4)
#define	GPIO_LCDP_SCL			EXYNOS5420_GPA2(5)
...
#define GPIO_BUCK1_SEL			EXYNOS5420_GPA2(6)
#define GPIO_BUCK2_SEL			EXYNOS5420_GPA2(7)

#define GPIO_BUCK3_SEL			EXYNOS5420_GPB0(0)
#define GPIO_BUCK4_SEL			EXYNOS5420_GPB0(1)
#define GPIO_BUCK6_SEL			EXYNOS5420_GPB0(2)
...
#define	GPIO_CODEC_SPI_SCK		EXYNOS5420_GPB1(1)
#define	GPIO_CODEC_SPI_SS_N		EXYNOS5420_GPB1(2)
#define	GPIO_CODEC_SPI_MISO		EXYNOS5420_GPB1(3)
#define	GPIO_CODEC_SPI_MOSI		EXYNOS5420_GPB1(4)

#define	GPIO_VIBTONE_PWM		EXYNOS5420_GPB2(1)
...
#define	GPIO_NFC_SDA_18V		EXYNOS5420_GPB3(2)
#define	GPIO_NFC_SCL_18V		EXYNOS5420_GPB3(3)
...
#define	GPIO_GPS_PWR_EN			EXYNOS5420_GPC1(2)
...
#define	GPIO_IRLED_SCL_28V		EXYNOS5420_GPC4(0)
#define	GPIO_IRLED_SDA_28V		EXYNOS5420_GPC4(1)

#define	GPIO_TOUCH_CHG			EXYNOS5420_GPD1(0)
#define	GPIO_NFC_IRQ			EXYNOS5420_GPD1(1)
#define	GPIO_PEN_PDCT_18V		EXYNOS5420_GPD1(2)
#define	GPIO_PEN_FWE1_18V		EXYNOS5420_GPD1(3)
#define	GPIO_PEN_LDO_EN			EXYNOS5420_GPD1(4)
#define	GPIO_MOTOR_SDA			EXYNOS5420_GPD1(5)
#define	GPIO_MOTOR_SCL			EXYNOS5420_GPD1(6)
#define	GPIO_PDA_ACTIVE			EXYNOS5420_GPD1(7)
...
#define	GPIO_PMIC_DVS3			EXYNOS5420_GPE0(3)
#define	GPIO_CAM_VT_nRST		EXYNOS5420_GPE0(4)
#define	GPIO_MAIN_CAM_RESET		EXYNOS5420_GPE0(5)
#define	GPIO_MAIN_AF_EN			EXYNOS5420_GPE0(6)
#define	GPIO_MAIN_AVDD_LDO_EN		EXYNOS5420_GPE0(7)

#define	GPIO_NFC_EN			EXYNOS5420_GPE1(0)
#define	GPIO_NFC_FIRMWARE		EXYNOS5420_GPE1(1)
...
#define	GPIO_BTP_SPI_CLK		EXYNOS5420_GPF1(4)
#define	GPIO_BTP_SPI_CS_N		EXYNOS5420_GPF1(5)
#define	GPIO_BTP_SPI_MISO		EXYNOS5420_GPF1(6)
#define	GPIO_BTP_SPI_MOSI		EXYNOS5420_GPF1(7)

#if 1 // HA3G code
#define	GPIO_MIPI_18V_EN			EXYNOS5420_GPF1(6)
#endif

#define	GPIO_BTP_RST_N			EXYNOS5420_GPG0(0)
#define	GPIO_CODEC_LDO_EN		EXYNOS5420_GPG0(1)
#define	GPIO_FPGA_CDONE			EXYNOS5420_GPG0(2)
#define	GPIO_MHL_INT			EXYNOS5420_GPG0(3)
#define	GPIO_CP_PMU_RST			EXYNOS5420_GPG0(4)
#define	GPIO_MOTOR_EN			EXYNOS5420_GPG0(5)

#define	GPIO_OLED_ID			EXYNOS5420_GPG0(6)
...
#define	GPIO_M_RST_N			EXYNOS5420_GPG2(0)
...
#define	GPIO_GRIP_DET_AP		EXYNOS5420_GPX0(4)
#define	GPIO_HOME_KEY			EXYNOS5420_GPX0(5)
#define	GPIO_TOUCH_EN			EXYNOS5420_GPX0(6)
#define	GPIO_DP_HPD			EXYNOS5420_GPX0(7)

#define	GPIO_GPS_HOST_WAKE		EXYNOS5420_GPX1(0)
#define	GPIO_GPS_HOST_WAKE_AF		0xF
#define	GPIO_IF_CON_SENSE		EXYNOS5420_GPX1(1)
#define	GPIO_IPC_HOST_WAKEUP		EXYNOS5420_GPX1(2)
#define	GPIO_ACC_INT1			EXYNOS5420_GPX1(3)
#define	GPIO_IF_PMIC_IRQ		EXYNOS5420_GPX1(4)
#define	GPIO_FUEL_ALERT			EXYNOS5420_GPX1(5)
#define	GPIO_TOUCH_EN_1			EXYNOS5420_GPX1(6)
#define	GPIO_ACC_INT2			EXYNOS5420_GPX1(7)
...
#define	GPIO_COND_DET_AP		EXYNOS5420_GPX2(3)
#define	GPIO_T_FLASH_DETECT		EXYNOS5420_GPX2(4)
#define	GPIO_CODEC_IRQ_N		EXYNOS5420_GPX2(5)
...
#define	GPIO_AP_PMIC_IRQ		EXYNOS5420_GPX3(0)
#define	GPIO_GYRO_INT			EXYNOS5420_GPX3(1)
#define	GPIO_BT_WAKE			EXYNOS5420_GPX3(2)
#define	GPIO_MSENSOR_INT		EXYNOS5420_GPX3(3)
#define	GPIO_GYRO_DRDY			EXYNOS5420_GPX3(4)
#define	GPIO_PEN_IRQ_18V		EXYNOS5420_GPX3(5)
#define	GPIO_PDA_ACTIVE_REV02		EXYNOS5420_GPX3(6)
#define	GPIO_MUIC_RESET_IRQ		EXYNOS5420_GPX3(6)
...
#define	GPIO_IRDA_IRQ			EXYNOS5420_GPY7(1)
#define	GPIO_VT_CAM_ID			EXYNOS5420_GPY7(2)
#define	GPIO_TA_INT			EXYNOS5420_GPY7(3)
#define	GPIO_TOUCH_RESET		EXYNOS5420_GPY7(4)
#define	GPIO_BTP_IRQ			EXYNOS5420_GPY7(5)
...
#define	GPIO_CODEC_RESET		EXYNOS5420_GPJ4(0)
