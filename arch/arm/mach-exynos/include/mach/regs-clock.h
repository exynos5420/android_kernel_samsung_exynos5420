...
#define EXYNOS5_MPLL_CON0			EXYNOS_CLKREG(0x10180)
#else
...
#ifdef CONFIG_SOC_EXYNOS5420
#define EXYNOS5_VPLL_CON0			EXYNOS_CLKREG(0x10170)
#define EXYNOS5_VPLL_CON1			EXYNOS_CLKREG(0x10174)
#define EXYNOS5_VPLL_CON2			EXYNOS_CLKREG(0x10178)
#else
...
#define EXYNOS5420_CLKSRC_TOP0			EXYNOS_CLKREG(0x10200)
#define EXYNOS5420_CLKSRC_TOP1			EXYNOS_CLKREG(0x10204)
#define EXYNOS5420_CLKSRC_TOP2			EXYNOS_CLKREG(0x10208)
#define EXYNOS5420_CLKSRC_TOP3			EXYNOS_CLKREG(0x1020C)

#ifdef CONFIG_SOC_EXYNOS5420
#define EXYNOS5_CLKSRC_TOP0			EXYNOS_CLKREG(0x10200)
#define EXYNOS5_CLKSRC_TOP1			EXYNOS_CLKREG(0x10204)
#define EXYNOS5_CLKSRC_TOP2			EXYNOS_CLKREG(0x10208)
#define EXYNOS5_CLKSRC_TOP3			EXYNOS_CLKREG(0x1020C)
#else
...
#define EXYNOS5_CLKSRC_TOP7			EXYNOS_CLKREG(0x1021C)
#define EXYNOS5_CLKSRC_TOP10			EXYNOS_CLKREG(0x10280)
...
#define EXYNOS5_CLKSRC_MASK_TOP0		EXYNOS_CLKREG(0x10300)
#define EXYNOS5_CLKSRC_MASK_TOP1		EXYNOS_CLKREG(0x10304)
#define EXYNOS5_CLKSRC_MASK_TOP2		EXYNOS_CLKREG(0x10308)
#define EXYNOS5_CLKSRC_MASK_TOP7		EXYNOS_CLKREG(0x1031C)
...
#ifdef CONFIG_SOC_EXYNOS5420
#define EXYNOS5_CLKDIV_TOP0			EXYNOS_CLKREG(0x10500)
#define EXYNOS5_CLKDIV_TOP1			EXYNOS_CLKREG(0x10504)
#define EXYNOS5_CLKDIV_TOP2			EXYNOS_CLKREG(0x10508)
#else
...
#define EXYNOS5_CLKGATE_BUS_TOP			EXYNOS_CLKREG(0x10700)
...
#define EXYNOS5_CLKGATE_BUS_PERIC		EXYNOS_CLKREG(0x10750)
#define EXYNOS5_CLKGATE_BUS_PERIC1		EXYNOS_CLKREG(0x10754)
#define EXYNOS5_CLKGATE_BUS_NOC			EXYNOS_CLKREG(0x10770)
...
#define EXYNOS5_CLKGATE_IP_MSCL			EXYNOS_CLKREG(0x10970)
...
#define EXYNOS5_CLKMUX_STAT_CDREX		EXYNOS_CLKREG(0x20400)
#define EXYNOS5_CLKDIV_CDREX			EXYNOS_CLKREG(0x20500)
#define EXYNOS5_CLKDIV_CDREX0			EXYNOS_CLKREG(0x20500)
#define EXYNOS5_CLKDIV_CDREX1			EXYNOS_CLKREG(0x20504)
...
#ifdef CONFIG_SOC_EXYNOS5420
#define EXYNOS5_PLL_DIV2_SEL			EXYNOS_CLKREG(0x20A2C)
#else
...
#ifdef CONFIG_SOC_EXYNOS5420
#define EXYNOS5_EPLL_LOCK			EXYNOS_CLKREG(0x10040)
#define EXYNOS5_CLKMUX_STAT_TOP0		EXYNOS_CLKREG(0x10400)
#define EXYNOS5_CLKMUX_STAT_TOP1		EXYNOS_CLKREG(0x10404)
#define EXYNOS5_CLKMUX_STAT_TOP2		EXYNOS_CLKREG(0x10408)
#define EXYNOS5_CLKMUX_STAT_TOP3		EXYNOS_CLKREG(0x1040C)
#define EXYNOS5_CLKMUX_STAT_TOP4		EXYNOS_CLKREG(0x10410)
#define EXYNOS5_CLKMUX_STAT_TOP5		EXYNOS_CLKREG(0x10414)
#define EXYNOS5_CLKMUX_STAT_TOP6		EXYNOS_CLKREG(0x10418)
#define EXYNOS5_CLKMUX_STAT_TOP7		EXYNOS_CLKREG(0x1041C)
#define EXYNOS5_CLKMUX_STAT_TOP10		EXYNOS_CLKREG(0x10480)
#define EXYNOS5_CLKMUX_STAT_TOP11		EXYNOS_CLKREG(0x10484)
#define EXYNOS5_CLKMUX_STAT_TOP12		EXYNOS_CLKREG(0x10488)
#define EXYNOS5_CLKDIV_STAT_TOP0		EXYNOS_CLKREG(0x10600)
#define EXYNOS5_CLKDIV_STAT_TOP1		EXYNOS_CLKREG(0x10604)
#define EXYNOS5_CLKDIV_STAT_TOP2		EXYNOS_CLKREG(0x10608)
#define EXYNOS5_CLKMUX_STAT_CMUTOP_SPARE3	EXYNOS_CLKREG(0x10B0C)
#else
...
#define EXYNOS5_CLKSRC_CMUTOP_SPARE2		EXYNOS_CLKREG(0x10B08)
