...
#ifdef CONFIG_EXYNOS_THERMAL
#define GPU_THROTTLING_90_95    550
...
static int gpu_tmu_hot_check_and_work(struct kbase_device *kbdev,
    ...
    case GPU_THROTTLING1:
        ...
        GPU_LOG(DVFS_INFO, DUMMY, 0u, 0u, "GPU_THROTTLING_90_95\n");
        break;
    case GPU_THROTTLING2:
        lock_clock = GPU_THROTTLING_95_100;
        GPU_LOG(DVFS_INFO, DUMMY, 0u, 0u, "GPU_THROTTLING_95_100\n");
        break;
    case GPU_THROTTLING3:
        lock_clock = GPU_THROTTLING_100_105;
        GPU_LOG(DVFS_INFO, DUMMY, 0u, 0u, "GPU_THROTTLING_100_105\n");
        break;
    case GPU_THROTTLING4:
        lock_clock = GPU_THROTTLING_105_110;
        GPU_LOG(DVFS_INFO, DUMMY, 0u, 0u, "GPU_THROTTLING_105_110\n");
        break;
    case GPU_TRIPPING:
        lock_clock = GPU_TRIPPING_110;
        GPU_LOG(DVFS_INFO, DUMMY, 0u, 0u, "GPU_THROTTLING_110\n");
        break;
    default:
				...
				unsigned long event, void *v)
{
	...
	GPU_LOG(DVFS_DEBUG, LSI_TMU_VALUE, 0u, event, "tmu event %lu\n", event);
