...
ssize_t gpu_thermal_throttling1(struct device *dev, struct device_attribute *attr, char *buf);
ssize_t gpu_thermal_throttling2(struct device *dev, struct device_attribute *attr, char *buf);
ssize_t gpu_thermal_throttling3(struct device *dev, struct device_attribute *attr, char *buf);
ssize_t gpu_thermal_throttling4(struct device *dev, struct device_attribute *attr, char *buf);
