...
DEVICE_ATTR(gpu_thermal1, 0444, gpu_thermal_throttling1, NULL);
DEVICE_ATTR(gpu_thermal2, 0444, gpu_thermal_throttling2, NULL);
DEVICE_ATTR(gpu_thermal3, 0444, gpu_thermal_throttling3, NULL);
DEVICE_ATTR(gpu_thermal4, 0444, gpu_thermal_throttling4, NULL);
