 ...
 * *********************************************************************
 * */
/*#define  	GPU_MIN_CLOCK		"/sys/devices/platform/mali.0/" -- Not available directly from sysfs. */
/*#define  	GPU_MAX_CLOCK		"/sys/devices/platform/mali.0/" -- Not available directly from sysfs. */
...
/*#define  	GPU_VERSION			"/sys/devices/platform/mali.0/gpu_version" -- Not available directly from sysfs. */
/*#define  	GPU_MEM				"/sys/devices/platform/mali.0/gpu_mem" -- Not available directly from sysfs. */
