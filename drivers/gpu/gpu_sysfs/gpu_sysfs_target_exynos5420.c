...
#define  	GPU_THERMAL1		"/sys/devices/platform/mali.0/throttling2"
#define  	GPU_THERMAL1		"/sys/devices/platform/mali.0/throttling3"
#define  	GPU_THERMAL1		"/sys/devices/platform/mali.0/throttling4"
...
ssize_t gpu_thermal_tripping(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	status = open_file_and_read_buffer(GPU_MEM, input_buffer, INPUT_BUFFER_SIZE_128);
