#ifndef _CYPRESS_TOUCHKEY_H_H
#define _CYPRESS_TOUCHKEY_H_H
...
#define FW_PATH_TC380 "coreriver/tc380.fw"
#define TKEY_MODULE07_HWID 8
#define TKEY_FW_PATH "/sdcard/cypress/fw.bin"
#define TKEY_TC380_FW_PATH "/sdcard/cypress/fw_tc380.bin"

#define TKEY_IC_TYPE_CYPRESS 1
#define TKEY_IC_TYPE_TC380 0
...
struct touchkey_i2c {
	...
	int (*fw_update)(struct touchkey_i2c *);
};
