...
#define SSP_FIRMWARE_REVISION_STM	15041500 /* from hw_rev 6 */
...
/* Bootload mode cmd */
#define BL_FW_NAME				"ssp_H_3G.fw"
#define BL_FW_NAME_REV5			"ssp_H_3G_rev5.fw"
#define BL_UMS_FW_NAME			"ssp_H_3G.bin"
...
unsigned int get_module_rev(struct ssp_data *data)
{
	if (data->ap_rev > 5)
		...
		return SSP_FIRMWARE_REVISION_STM_REV5;
}
...
int check_fwbl(struct ssp_data *data)
{
	...
	if (data->ap_rev > 5)
		...
		fw_revision = SSP_FIRMWARE_REVISION_STM_REV5;
