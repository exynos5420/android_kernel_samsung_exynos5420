...
#define ONLINE_TYPE_RSVD_MASK	(0xFF << ONLINE_TYPE_RSVD_SHIFT)
#define ONLINE_TYPE_MAIN_SHIFT	16
#define ONLINE_TYPE_MAIN_MASK	(0xFF << ONLINE_TYPE_MAIN_SHIFT)
#define ONLINE_TYPE_SUB_SHIFT	8
#define ONLINE_TYPE_SUB_MASK	(0xFF << ONLINE_TYPE_SUB_SHIFT)
#define ONLINE_TYPE_PWR_SHIFT	0
#define ONLINE_TYPE_PWR_MASK	(0xFF << ONLINE_TYPE_PWR_SHIFT)
...
/* check */
extern int power_supply_set_current_limit(struct power_supply *psy,
		int limit);
